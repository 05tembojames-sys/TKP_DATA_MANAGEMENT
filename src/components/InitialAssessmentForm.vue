<template>
  <div class="form-wrapper">
    <div class="form-header">
      ...
      <p>Complete this form to assess child eligibility for The Kukhoma Project</p>
    ...
    <div class="assessment-form">
      ...
      <div v-show="currentSection === 1" class="form-section">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            <label>Age *</label>
            <input v-model="formData.age" type="number" min="0" max="18" required />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label>Does the child qualify according to TKP's age criteria? *</label>
      ...
      <div v-show="currentSection === 2" class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group">
            ...
            <input v-model="formData.estimatedConceptionDate" type="date" required />
          </div>
          <div class="form-group">
            <label>Duration of Pregnancy (weeks) *</label>
            <input v-model="formData.pregnancyDuration" type="number" min="0" max="40" required />
          </div>
          <div class="form-group">
        ...
        <div class="form-group full-width">
          <label>Describe how the baby's conception occurred (i.e., location, time of day, reason, etc) *</label>
          <textarea v-model="formData.conceptionDescription" rows="4" required></textarea>
        </div>
        <div class="form-group full-width">
      ...
      <div v-show="currentSection === 3" class="form-section">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            <label>Has there been consideration/attempts of abortion by the child or the family? *</label>
          ...
          <div class="form-group">
            <label>Has the child expressed a desire to commit suicide/attempted to commit suicide? *</label>
      ...
      <div v-show="currentSection === 5" class="form-section">
        ...
        <div class="form-group full-width">
          ...
          <textarea v-model="formData.homeCondition" rows="4" required></textarea>
        </div>
        <div class="form-group full-width">
          <label>Describe the economic situation of the family *</label>
          <textarea v-model="formData.economicSituation" rows="4" required></textarea>
        </div>
        <div class="section-navigation">
          <button type="button" class="prev-btn" @click="prevSection">‹ Previous Section</button>
          <button type="button" class="next-btn" @click="nextSection">Next Section ›</button>
      ...
      <div v-show="currentSection === 6" class="form-section">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <input v-model="formData.mostRecentYear" type="number" min="1900" max="2030" />
          </div>
          <div class="form-group">
      ...
      <div v-show="currentSection === 7" class="form-section">
        ...
        <div class="form-group full-width">
          ...
          <textarea v-model="formData.healthIssuesDescription" rows="3"></textarea>
        </div>
        <div class="section-navigation">
          <button type="button" class="prev-btn" @click="prevSection">‹ Previous Section</button>
          <button type="button" class="next-btn" @click="nextSection">Next Section ›</button>
      ...
      <div v-show="currentSection === 8" class="form-section">
        ...
        <div class="form-grid">
          <div class="form-group">
            <label>Has the family considered placing the baby for adoption? *</label>
          ...
          <div class="form-group">
            <label>Would the family be open to placing the baby for adoption? *</label>
      ...
      <div v-show="currentSection === 9" class="form-section">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            <label>Conception from Sexual Abuse/Rape/Survival Prostitution *</label>
        ...
        <div class="form-group full-width">
          ...
          <textarea v-model="formData.recommendationDescription" rows="4" required></textarea>
        </div>
        <div class="section-navigation">
          <button type="button" class="prev-btn" @click="prevSection">‹ Previous Section</button>
...
Do you want to continue and create this assessment anyway?`
    ...
    if (result.success) {
      ...
      emit('form-saved', { formType: 'initial-assessment', id: result.id })
